...
import { Mic, MicOff, BookOpen, AlertCircle, Loader2 } from 'lucide-react';
        ...
        <div className="relative z-20 flex justify-between items-start">
             <div>
                ...
                <p className="text-slate-400 mt-1 text-sm">
                    High-Precision Audio Processing
                </p>
            </div>
      ...
      >
        {messages.length === 0 && !isRecording && !isProcessingBatch && (
          <div className="h-full flex flex-col items-center justify-center text-slate-500 text-center p-8 gap-4">
            ...
            <div>
                <p className="text-lg font-bold text-slate-400 mb-2">Ready to Record</p>
                <p className="text-sm max-w-xs mx-auto text-slate-500">
                    I will record a segment and provide a high-precision transcription using Gemini.
                </p>
            </div>
          </div>
        )}
        ...
        {isRecording && (
           <div className="sticky bottom-0 left-0 right-0 flex justify-center pb-2 pointer-events-none">
                <div className="backdrop-blur-md px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest flex items-center gap-2 shadow-lg border animate-pulse bg-blue-900/80 text-blue-200 border-blue-500/30">
